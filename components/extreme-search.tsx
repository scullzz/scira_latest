...
const ExtremeSearchComponent = ({
    ...
    const latestStatusAnnotation = useMemo(
        () =>
            (annotations as any[])
                ?.filter(
                    (ann) => ann && (ann.status || ann.plan) && (typeof ann.status?.title === 'string' || ann.plan),
                )
                .pop(),
        [annotations],
    );
        ...
        () =>
            (annotations as any[])?.reduce((acc: QueryBlockData[], annotation: any) => {
                ...
                if (annotation.type === 'search_query' && typeof annotation.query === 'string') {
                    ...
                    annotation.content &&
                    typeof annotation.content.url === 'string'
                ) {
                    // Find the query by queryId if available, otherwise use the last query
                    const queryId = annotation.queryId;
                    const targetQuery = queryId
    ...
    useEffect(() => {
        if (timelineContainerRef.current && timelineItems.length > 0) {
    ...
    }, [timelineItems.length, expandedItems]);
    ...
    const renderTimeline = () => (
        <div
            ...
            className="space-y-2 max-h-[350px] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-neutral-200 hover:scrollbar-thumb-neutral-300 dark:scrollbar-thumb-neutral-700 dark:hover:scrollbar-thumb-neutral-600 scrollbar-track-transparent"
        >
            <AnimatePresence>
                    ...
                    return (
                        ...
                        >
                            ...
                            >
                                ...
                                {item.type === 'search' && (
                                    <Search className="w-3.5 h-3.5 text-neutral-500 dark:text-neutral-400 flex-shrink-0" />
                                )}
                                {item.type === 'code' && (
                                    <span className="text-neutral-500 dark:text-neutral-400 flex-shrink-0 font-mono text-xs">
                                        {'{}'}
                                    </span>
                                )}
                                                            ...
                                                            {item.searchData.sources.map((source, index) => (
                                                                ...
                                                                >
                                                                    <img
                                                                        ...
                                                                        onError={(e) => {
                                                                            e.currentTarget.src =
                                                                                'https://www.google.com/s2/favicons?sz-128&domain_url=example.com';
                                                                            (
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="flex items-center gap-2.5 p-3 pb-2">
                                                ...
                                                />
                                                <span
                                                    className="truncate text-neutral-900 dark:text-neutral-100 text-sm font-medium flex-1"
                                                    title={displayTitle}
                                                >
                                                    {displayTitle}
                                                </span>
            ...
            new Map(
                (research?.sources || []).map((s) => [
                    s.url,
                    {
                        ...
                        favicon:
                            s.favicon ||
                            `https://www.google.com/s2/favicons?sz-128&domain_url=${encodeURIComponent(s.url)}`,
                    },
                ]),
            ).values(),
                ...
                {allCharts.length > 0 && (
                    <div className="mb-6">
                        <div className="flex items-center gap-2 mb-3">
                            ...
                            <div className="text-xs px-2 py-0.5 bg-neutral-100 dark:bg-neutral-800 rounded-full text-neutral-500 dark:text-neutral-400">
        ...
        >
            <Card className="w-full mx-auto gap-0 py-0 mb-4 shadow-none overflow-hidden">
                ...
                <CardContent className="p-3 pt-2">
                    ...
                    <div
                        ref={timelineContainerRef}
                        className="space-y-2 max-h-[350px] overflow-y-auto pr-1 scrollbar-thin scrollbar-thumb-neutral-200 hover:scrollbar-thumb-neutral-300 dark:scrollbar-thumb-neutral-700 dark:hover:scrollbar-thumb-neutral-600 scrollbar-track-transparent"
                    >
                        {renderTimeline()}
                    </div>
                </CardContent>
