...
const ExtremeSearchComponent = ({
    ...
    const queriesWithSources: QueryBlockData[] =
                    ...
                    {queriesWithSources.map((queryData, queryIndex: number) => {
                        ...
                        const systemIsReadingThisSpecificQueryContent =
                            ...
                            latestStatusAnnotation?.status?.title?.includes(
                                `Reading content from search results for "${query}"`,
                            );
                                    ...
                                    style={{
                                        ...
                                        height: expandedQueries[query]
                                            ? // If this is the last item, don't extend too far when expanded
                                              queryIndex === queriesWithSources.length - 1
                                                ? 'calc(100% - 9px)'
                                                : '100%'
                                    ...
                                    {expandedQueries[query] && (
                                        ...
                                        >
                                            <div className="pl-1 py-1">
                                                ...
                                                {(() => {
                                                    const statusForText =
                                                        systemIsReadingThisSpecificQueryContent &&
                                                        calculatedQueryStatus !== 'no_results'
                                                            ? 'loading'
